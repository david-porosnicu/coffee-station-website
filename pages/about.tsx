        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-coffee-600">
              A Next.js application with VAPI.ai voice bot integration (via CDN)
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-coffee-600 text-sm mb-3">
                    Powered by VAPI.ai for natural voice conversations with
                    customers (via CDN script).
                  </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="bg-gray-900 text-green-400 p-3 rounded font-mono text-sm">
                    git clone
                    https://github.com/david-porosnicu/coffee-station-website.git
                    <br />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-coffee-600 text-sm">
                    Don't forget to add your environment variables in the Vercel
                    dashboard.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">
              <h2 className="text-2xl font-bold text-coffee-900 mb-4">
                ⚙️ VAPI.ai Setup & Troubleshooting
              </h2>
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-coffee-800 mb-2">
                  ...
                  <ol className="text-coffee-600 space-y-2 text-sm list-decimal list-inside">
                    ...
                    <li>Add them to your .env.local file as shown above</li>
                  </ol>
                </div>
                <div>
                  <h3 className="font-semibold text-coffee-800 mb-2">
                  ...
                  <ul className="text-coffee-600 text-sm list-disc list-inside">
                    <li>
                      • Ensure your .env.local contains{" "}
                      <b>NEXT_PUBLIC_VAPI_API_KEY</b> and{" "}
                      <b>NEXT_PUBLIC_VAPI_BOT_ID</b>.
                    </li>
                    <li>• Restart your dev server after editing .env.local.</li>
                    <li>
                      • Check the browser console for errors and ensure the CDN
                      script loads successfully.
                    </li>
                    <li>
                      • Make sure your API key and Bot ID are correct and active
                      in your VAPI dashboard.
                    </li>
                    <li>
                      • Only <b>NEXT_PUBLIC_</b> variables are available in the
                      browser; do not use server-only env variable names.
                    </li>
                  </ul>
                </div>
              </div>

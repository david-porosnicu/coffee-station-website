      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-coffee-900 mb-4">Talk to Our AI Assistant</h1>
            <p className="text-xl text-coffee-600 max-w-2xl mx-auto">
              Experience our revolutionary voice-powered ordering system. Ask about our menu, place orders, or get
          ...
          {/* Call Widget */}
          <div className="mb-12">
            <CallWidget onCallStart={() => setCallStarted(true)} onCallEnd={() => setCallStarted(false)} />
          </div>

          {/* Instructions */}
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-xl font-semibold text-coffee-900 mb-4">How to Use Our Voice Assistant</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-medium text-coffee-800 mb-2">What You Can Ask:</h3>
                ...
                <div>
                  <h3 className="font-medium text-coffee-800 mb-2">Tips for Best Experience:</h3>
                  <ul className="text-coffee-600 space-y-1 text-sm">
